...
```bash
docker run -it -p 1883:1883 -p 8161:8161 dinifarb/activemq:6.2.0
```
...
|```dinifarb/activemq:5.16.1```|```dinifarb/activemq:5.17.1```|```dinifarb/activemq:5.18.1```|```dinifarb/activemq:5.19.1```|
...
|```dinifarb/activemq:5.16.8```||||

### v6
|**6.0.x**|**6.1.x**|**6.2.x**|
|-----|-----|-----|
|```dinifarb/activemq:6.0.0```|```dinifarb/activemq:6.1.0```|```dinifarb/activemq:6.2.0```|
